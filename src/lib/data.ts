...
export const initialUsers: Omit<User, 'id'>[] = [
    { 
        ...
        bannerUrl: 'https://placehold.co/1200x300/1e40af/ffffff?text=Admin+Banner',
...
export const initialBooks: Omit<Book, 'id'>[] = [
    {
        ...
        coverUrl: 'https://placehold.co/300x450.png/4ade80/ffffff?text=Book+1',
    ...
    },
    {
        ...
        coverUrl: 'https://placehold.co/300x450.png/60a5fa/ffffff?text=Book+2',
        category: 'Distopía',
        stock: 3,
    },
    {
        ...
        coverUrl: 'https://placehold.co/300x450.png/f59e0b/ffffff?text=Book+3',
        category: 'Fantasía',
        stock: 4,
    },
    {
        ...
        coverUrl: 'https://placehold.co/300x450.png/ef4444/ffffff?text=Book+4',
    ...
    },
    {
        ...
        coverUrl: 'https://placehold.co/300x450/8b5cf6/ffffff?text=Book+5',
        category: 'Romance',
        stock: 8,
    },
    {
